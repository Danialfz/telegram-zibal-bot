    ...
    if st:
        ...
        if step == "amount":
            try:
                ...
                return bot.reply_to(m, "عدد نامعتبر است، لطفاً مقدار را فقط به عدد وارد کنید.")
            ...
            bot.send_message(ADMIN_ID,
                             ...
                             f"ارز: {st['currency']}\n"
                             f"مقدار: {st['amount']}\n\n"
                             f"لطفاً نرخ هر واحد (تومان) را وارد کنید.")
            ...
            if "✅" in text or "تایید" in text or "بله" in text:
                ...
                if direction == "از داخل به خارج":
                    bot.send_message(chat_id,
                                     "لطفاً اطلاعات حساب دریافت‌کننده را وارد کنید:\n"
                                     "📄 نام و نام خانوادگی دریافت‌کننده\n"
                                     "💳 شماره حساب / کارت / شبا\n"
                                     "👤 نام و نام خانوادگی واریزکننده")
                else:
                    bot.send_message(chat_id,
                                     "لطفاً اطلاعات حساب خود را جهت دریافت وجه وارد کنید:\n"
                                     "📄 نام و نام خانوادگی\n"
                                     "💳 شماره حساب / کارت / شبا")
